				...
				<div class="znfb-row">
						...
						<div class="zn-lead-text">
							...
							if( ! $isConnected ){ ?>
								<div class="zn-adminNotice zn-adminNotice-error">
									...
									<p>Please go back to step 2 (Theme Registration) and register <?php echo ZNHGTFW()->getThemeName(); ?> to gain full access to the Plugins.</p>
									<p><br/><strong><em>If you still see this message after registering your theme, please reload this page.</em></strong></p>
								</div>
							<?php }
							else {
								?>
								<p class="zn-lead-text--larger">These are premium and free plugins that have been used in <?php echo ZNHGTFW()->getThemeName(); ?> theme for certain functionalities and pages. Unless specified otherwise, most of them are optional and they can be installed later.</p>
							<?php
							}
							?>
						</div>
					...
					<?php if( $isConnected ){ ?>
						<div class="<?php echo esc_attr($section2_cols);?>">
							<a href="#" class="js-refresh-plugins zntfw_admin_button zn-refresh-theme-plugins-button" title="Click to refresh the plugins list" data-nonce="<?php echo wp_create_nonce('refresh_plugins_list');?>">Refresh List</a>
						</div>
					<?php } ?>
				</div>
