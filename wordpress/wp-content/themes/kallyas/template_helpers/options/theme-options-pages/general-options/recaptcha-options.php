...
$admin_options[] = array (
	...
	"description" => __( 'Please specify the language to display the ReCaptcha in. You can get it from  <a href="' .
		esc_url( 'https://developers.google.com/recaptcha/docs/language' ) . '" target="_blank">here</a>', 'zn_framework' ),
	"id"          => "recaptcha_lang",
	"std"         => 'en',
	"type"        => "text",
);
