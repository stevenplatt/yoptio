		...
		if ( is_user_logged_in() )
		{
			if ( current_user_can( 'administrator' ) )
			{
				...
				$wp_admin_bar->add_node( array(
					...
					'id' => 'kallyas-theme-options-submenu-item-dashboard',
					'title' => __( 'Dashboard', 'zn_framework' ),
					'href' => admin_url( 'admin.php' ) . '?page=zn-about',
				) );
				$wp_admin_bar->add_node( array(
					'parent' => 'kallyas-theme-options-submenu-item-dashboard',
					'id' => 'kallyas-theme-options-submenu-item-dashboard-register',
					'title' => __( 'Theme Registration', 'zn_framework' ),
					'href' => admin_url( 'admin.php' ) . '?page=zn-about#zn-about-tab-registration-dashboard',
				) );
				$wp_admin_bar->add_node( array(
					'parent' => 'kallyas-theme-options-submenu-item-dashboard',
					'id' => 'kallyas-theme-options-submenu-item-dashboard-addons',
					'title' => __( 'Theme Addons', 'zn_framework' ),
					'href' => admin_url( 'admin.php' ) . '?page=zn-about#zn-about-tab-addons-dashboard',
				) );
				$wp_admin_bar->add_node( array(
					'parent' => 'kallyas-theme-options-submenu-item-dashboard',
					'id' => 'kallyas-theme-options-submenu-item-dashboard-demos',
...
/**
 * Load Kallyas Menu & Admin Bar menu CSS to separate items
 * @since 4.12
 */
add_action('admin_enqueue_scripts', 'zn_load_kallyas_admin_menus_css');
add_action('wp_enqueue_scripts', 'zn_load_kallyas_admin_menus_css');
if(!function_exists('zn_load_kallyas_admin_menus_css')){
	function zn_load_kallyas_admin_menus_css(){
		if ( is_user_logged_in() && current_user_can( 'administrator' ) ) {
			wp_enqueue_style( 'kallyas_admin_menu_css', THEME_BASE_URI . '/css/admin/kallyas_menu_separators.css', false, ZN_FW_VERSION );
		}
	}
}
