...
function zn_woocommerce_product_thumbnails_move() {
	...
	// stop if slider is enabled
	if( zget_option('zn_woo_enable_slider', 'zn_woocommerce_options', false, 'no') == 'no' ) {
		...
		add_action('woocommerce_single_product_summary', 'woocommerce_show_product_thumbnails_div_start_wooslider', 19);
	    add_action('woocommerce_single_product_summary', 'zn_close_div', 19);
	}
}

function woocommerce_show_product_thumbnails_div_start_wooslider()
{
	echo '<div class="zn-wooGalleryThumbs-summary">';
}
