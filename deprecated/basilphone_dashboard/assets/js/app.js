...
jQuery(document).ready(function(){
	 ...
	 jQuery('.findnumber .btn-info').click(function(e){
		...
		jQuery('.reserve_number .btn-info').click(function(e){
			if(jQuery(this).hasClass('btn-oreserve')){
				...
				var areacode       = jQuery('#edd_office_number_area_code').val();
				var friendly       = jQuery('#edd_office_friendlyName').val();
				var method="office";
			}else{
				var phonenumber    = jQuery('#edd-conference_number').val();
				var areacode       = jQuery('#edd_conference_number_area_code').val();
				var friendly       = jQuery('#edd_conference_friendlyName').val();
				var method="conference";
			}
	...
	jQuery(document).on('change', '[name^=purchase_number]', function(e){
	   ...
	   if(ref.data('action')=="office"){
		 ...
		 jQuery('#edd_office_number_area_code').val(ref.data('areacode'));
		 jQuery('#edd_office_friendlyName').val(ref.data('friendly'));
		 jQuery('.office_number .num').html(ref.val());
	   }
       else{
		   jQuery('#edd-conference_number').val(ref.val()); 
		   jQuery('#edd_conference_number_area_code').val(ref.data('areacode'));
		   jQuery('#edd_conference_friendlyName').val(ref.data('friendly'));
